...
import math
#Nouvelle fonction companion utiliser un coin avec la condition y>mid ymax où y en dessous. La fonction collide en dehors du choix fait pour la moitié de l'écran sera vectorisé par rapport à son centre afin d'appliquer ce vecteur au companion. Ce dernier reprendra les propriétés collide rebond des les autres entités. vect neg de c sur pav
