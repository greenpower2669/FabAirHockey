...
######:
	######:
    	...
    	if collide(pavx,pavy,xb,yb,mdbe) and stopb==0 and not collide(xh,yh,xb,yb,mdbe) and pbb==0:
    		...
    		if fpav<10 and fb<10 and choixidb>0:
    			stopb=1
    		if fb>fpav:
    			#fpav=fb+accb/10
    	...
    	if stopb==1:
    		pavx,pavy=xb,yb
    		if accb*accb>120 or choixidb<1:
    			stopb=0
    			pavx0,pavy0=pavx,pavy
    			fpav,vpavx,vpavy,pbb=fb*1.5,-vxb,-vyb,1
    			pavx,pavy=pavx+accb*mult2*vpavx*fpav,pavy+vpavy*fpav*accb*mult2
    			
    	if stoph==1:
    		pavx,pavy,fpav=xh,yh,fh*1.5
    		if acch*acch>120 or choixidh<1:
    			stoph=0
    			pavx0,pavy0=pavx,pavy
    			fpav,vpavx,vpavy,pbh=fh*1.5,-vxh,-vyh,1
    			pavx,pavy=pavx+mult2*acch*vpavx*fpav,pavy+acch*mult2*vpavy*fpav
