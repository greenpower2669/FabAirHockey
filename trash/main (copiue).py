...
class jah(FloatLayout):
    ...
    def update_touch_label(self, label, touch):
        global xmax,ymax,xh,yh,xb,yb,h,b,ih,ib,fh,fb,timeappuh,timeappub,timelacheh,timelacheb,choixidh,choixidb,test,pbt
        label.text = 'ID: %s\joueurh et force (%d,%d,%d)\n choix h et b (%d,%d) milieu?%d /nPos: (%d, %d)\nClass: %s' % (
            touch.id, xh,yh,fh,choixidh,choixidb,pbt,touch.x, touch.y, touch.__class__.__name__)
    ...
    def screen_up(self,time_passed,**kwargs):
    	global test,pavx,xh,pavy,yh,xmax,ymax,xh,yh,xb,yb,h,b,ih,ib,timeappuh,timeappub,timelacheh,timelacheb,choixidh,choixidb,test,pavx,pavy,vpavx,vpavy,fpav,mp,vxh,vxb,vyh,vyb,fh,fb,pbt,pbh,pbb,pbd,wh,wb,wg,wd,bh,bb,bg,bd,hh,hb,hg,hd,sch,scb
