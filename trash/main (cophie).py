...
class jah(FloatLayout):
    ...
    def screen_up(self,time_passed,**kwargs):
    	...
    	if jhcoul==10:
    			...
    			#<<<<<<<<   coul
    	if collide(xb,yb,xmax/4+50,ymax/2,80) or collide(xb,yb,xmax/4*3+50,ymax/2,80):
    		treset+=1
    		if collide(xb,yb,xmax/4+50,ymax/2,80):
    			coul(self,'g',treset)
    		else:
    			coul(self,'d',treset)
