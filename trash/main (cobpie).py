...
def coul(self,ou,scr,**kwargs):
	...
	with self.canvas.before:
		...
		el3=Ellipse(pos=(x+9,y+9), size=(180-18,180-18),group=pts)
		#fin coul
...
class jah(FloatLayout):
    ...
    def __init__(self, **kwargs):
    	...
    	with self.canvas:
    		...
    		self.jh=Rectangle(source='jh0.png',pos=(xh-mh,yh-mh),size=(151,151))
    		self.jb=Rectangle(source='jb0.png',pos=(xb-mb,yb-mb),size=(151,151))
    ...
    def screen_up(self,time_passed,**kwargs):
    	...
    	if collide(xh,yh,xmax/4+50,ymax/2,150) or collide(xh,yh,xmax/4*3+50,ymax/2,150):
    		treset+=1
    		if collide(xh,yh,xmax/4+50,ymax/2,150):
    			coul(self,'g',treset)
    		else:
    			coul(self,'d',treset)
    	...
    	if jhcoul==10:
    			...
    			#<<<<<<<<   coul
    	if collide(xb,yb,xmax/4+50,ymax/2,150) or collide(xb,yb,xmax/4*3+50,ymax/2,150):
    		treset+=1
    		if collide(xb,yb,xmax/4+50,ymax/2,150):
    			coul(self,'g',treset)
    		else:
    			coul(self,'d',treset)
